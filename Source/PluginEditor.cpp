      ...
      keyboardComponent (p.keyboardState, MidiKeyboardComponent::horizontalKeyboard)
{
    ...
    harm4Label.setText ("4th Harmonic", dontSendNotification);
    harm4Label.setJustificationType (Justification::centred);
    addAndMakeVisible (harm4Label);
    ...
    addAndMakeVisible (harm4Slider);
    harm4Attachment = new SliderAttachment (valueTreeState, "harm4", harm4Slider);
...
void PyoAddSynthAudioProcessorEditor::resized()
{
    Rectangle<int> area (getLocalBounds());
    {
        ...
        harm2Label.setBoundsRelative (0.05, 0.05, 0.2, 0.1);
        harm2Slider.setBoundsRelative (0.25, 0.05, 0.70, 0.1);

        harm3Label.setBoundsRelative (0.05, 0.15, 0.2, 0.1);
        harm3Slider.setBoundsRelative (0.25, 0.15, 0.70, 0.1);

        harm4Label.setBoundsRelative (0.05, 0.25, 0.2, 0.1);
        harm4Slider.setBoundsRelative (0.25, 0.25, 0.70, 0.1);
